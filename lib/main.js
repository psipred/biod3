...
function drawChart(error, exampleSS){
  ...
  biod3_genericGrid(exampleSS, 'ss', 50, "psipredChart", {annotation_sets: ['lesk', 'clustal'], download_buttons: true, grid_label: true, grid_colour_type: "custom", grid_colour_annotations: ["ss", "disopred", "dompred"], custom_grid_palette: custom });
