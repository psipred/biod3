...
function drawChart(error, exampleSS){
  ...
  biod3_genericGrid(exampleSS, 'ss', 50, "psipredChart", {download_buttons: true, grid_key: key, grid_label: true, grid_colour: "custom", grid_colour_values: "psipred", custom_grid_palette: custom });
