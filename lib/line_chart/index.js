...
export function biod3_genericxyLineChart(data, xseries, yseries, lineColours, label='xyLineChart', opts={})
{
  ...
  if(chart.xcutoff)
  {
    add_cutoff_line(chart, chart.xcutoff, "x");
  }
  if(chart.ycutoff)
  {
    add_cutoff_line(chart, chart.ycutoff, "x");
  }
}
...
function add_cutoff_line(chart, value, axis)
{
  console.log("Drawing DASHED CUTOFF over"+axis);
}
