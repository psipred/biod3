...
export function biod3_psipred(data, label="psipredChart", opts={})
{
  ...
  opts = Object.assign(opts, {key_panel: false, download_buttons: true});
...
function drawKey(chart, data_array, key_position, label)
{
  ...
  {
    button_helper(chart, label, "png", 0, "container", chart.container_width*0.8, key_position);
    button_helper(chart, label, "svg", chart.em_size*5, "container", chart.container_width*0.8, key_position);
