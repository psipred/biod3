...
function drawKey(chart, data_array, key_position, label)
{
  ...
  {
    button_helper(chart, "png", 0, "container", chart.container_width*0.8, key_position);
    button_helper(chart, "svg", chart.em_size*5, "container", chart.container_width*0.8, key_position);
