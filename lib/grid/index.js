...
export function biod3_genericGrid(data, cellseries, xdimension, label="seqAnnotationChart", opts={})
{
  ...
  {
    add_annotation_toggle(chart, "toggle");
  }
}

function add_annotation_toggle(chart, type)
{
...
function drawLegend(chart)
{
  if(chart.grid_key)
  {
    ...
    key.enter().append("rect")
      ...
      .attr("stroke", function(d){const colour="white"; if(d.stroke){return d.stroke;} return colour;})
      .attr("fill", function(d){const colour="white"; if(d.fill){return d.fill;} return colour;});
