...
//
export function biod3_psipredGrid(data)
{
  biod3_genericGrid(data, 'res', 50, "psipredChart", {annotation_sets: annotations, download_buttons: true, grid_label: true, grid_colour_type: "custom", grid_colour_annotations: ["ss", "disopred", "dompred"], custom_grid_palette: custom });
}
