...
export function biod3_annotationGrid(data, opts={})
{
  ...
  biod3_genericGrid(data, 'res', 50, "annotationChart", psipred_opts);
}
  ...
  if(chart.custom_grid_palette && chart.grid_colour_type === 'custom')
  {
    ...
    key.enter().append("rect")
      ...
      .attr("transform", function(d, i){
            ...
            let out_array = [(label_counter*12*chart.em_size)+chart.margin.left, y_pos*chart.em_size*1.4];
            label_counter+=1;
    ...
    text.enter().append("text")
      .attr("transform", function(d, i){
            ...
            let out_array = [(label_counter*12*chart.em_size)+chart.margin.left+(chart.em_size*1.2), (y_pos*chart.em_size*1.4)+chart.em_size/1.5];
            label_counter+=1;
          return "translate("+out_array+")";})
